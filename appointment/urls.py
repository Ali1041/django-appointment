...
from appointment.views_admin import (
    ...
    add_or_update_staff_info,
    add_staff_member_info,
    add_working_hours,
    ...
    fetch_service_list_for_staff,
    fetch_staff_list,
    get_service_list,
    get_user_appointments,
    is_user_staff_admin,
    make_superuser_staff_member,
    remove_staff_member,
    remove_superuser_staff_member,
    update_appt_date_time,
    update_appt_min_info,
    update_day_off,
...
admin_urlpatterns = [
    ...
    path(
        "appointments/<str:response_type>/",
        get_user_appointments,
        name="get_user_event_type",
    ),
    ...
    path(
        ...
        create_new_staff_member,
        name="add_staff_member_personal_info",
    ),
    path(
    ...
    path(
        "make-superuser-staff-member/",
        make_superuser_staff_member,
        name="make_superuser_staff_member",
    ),
    path(
        "remove-superuser-staff-member/",
        remove_superuser_staff_member,
        name="remove_superuser_staff_member",
    ),
    # remove staff member
    path(
    ...
    path(
        "update-service/<int:service_id>/", add_or_update_service, name="update_service"
    ),
    ...
    path(
        "service-list/<str:response_type>/",
        get_service_list,
        name="get_service_list_type",
    ),
    path(
        "view-service/<int:service_id>/<int:view>/",
        add_or_update_service,
        name="view_service",
    ),
    # display details for one event
    path(
        "display-appointment/<int:appointment_id>/",
        display_appointment,
        name="display_appointment",
    ),
    # complete profile
    ...
    path(
        ...
        update_day_off,
        name="update_day_off_id",
    ),
    path(
        "delete-day-off/<int:day_off_id>/<int:staff_user_id>/",
        delete_day_off,
        name="delete_day_off_id",
    ),
    ...
    path(
        ...
        add_working_hours,
        name="add_working_hours_id",
    ),
    path(
        "delete-working-hours/<int:working_hours_id>/<int:staff_user_id>/",
        delete_working_hours,
...
ajax_urlpatterns = [
    ...
    path(
        "delete_appointment/", delete_appointment_ajax, name="delete_appointment_ajax"
    ),
...
urlpatterns = [
    ...
    path(
        "request-submit/", appointment_request_submit, name="appointment_request_submit"
    ),
    path(
        "appointment/<str:id_request>/reschedule/",
        prepare_reschedule_appointment,
    ...
    path(
        "confirm-reschedule/<str:id_request>/",
        confirm_reschedule,
        name="confirm_reschedule",
    ),
    path(
        "client-info/<int:appointment_request_id>/<str:id_request>/",
        appointment_client_information,
        name="appointment_client_information",
    ),
    path(
        "verification-code/<int:appointment_request_id>/<str:id_request>/",
        enter_verification_code,
    ...
    path(
        "verification-code/",
        email_change_verification_code,
        name="email_change_verification_code",
    ),
    path(
        "thank-you/<int:appointment_id>/", default_thank_you, name="default_thank_you"
    ),
